                    ...
                    <div className="main-block">
                        <Switch>
                            ...
                            <Route
                                path="/"
                                exact
                                component={() => <JackpotClassic type={"tf2"} />}
                            />
                            <Route
                                path="/rust"
                                exact
                                component={() => <JackpotClassic type={"rust"} />}
                            />

                            <Route
                                path="/jackpothigh"
                                exact
                                component={() => <JackpotHigh type={"tf2"} />}
                            />
                            <Route
                                path="/rust/jackpothigh"
                                exact
                                component={() => <JackpotHigh type={"rust"} />}
                            />

                            <Route
                                path="/coinflip"
                                exact
                                component={() => <Coinflip type={"tf2"} />}
                            />
                            <Route
                                path="/rust/coinflip"
                                exact
                                component={() => <Coinflip type={"rust"} />}
                            />
                            ...
                            <Route path="/fastgame" exact component={() => <Fast />} />
