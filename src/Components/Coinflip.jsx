...
function Coinflip({ type }) {
    ...
    return <div className="coinflip">
        <div className="classBetsSet">
            ...
            <span>Добро пожаловать в Coinflip (подброс монеты).В ней вы сразитесь 1 на 1 <br /> с другим игроком при приблизительно равных на победу шансах.</span>
            <img src={`${process.env.PUBLIC_URL}/img/2arr.png`}></img>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="cf-inventory">
                            ...
                            <div class="cf-inventory-body">
                                <div class="cf-item" data-id="440_7871538233">
                                </div>
                            </div>
                            <div class="cf-item-image" style={{"border-top": "1px solid #bc0000"}}>
