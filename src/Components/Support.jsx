            ...
            <div className="support-chat__row">
                <div className="support-chat__header">
                    <div className="support-chat__title">
                        Начните ваш диалог с поддержкой написав нам первое
                        сообщение:
                    </div>
                </div>
                            ...
                            <div className="messages__item item my-message">
                                <div className="item__body">
                                    <div className="item__grid">
                                        ...
                                        <div className="item__msg">
                                            Lorem ipsum dolor sit amet,
                                            consectetur adipisicing elit.
                                            Blanditiis veniam cumque sit
                                            architecto perspiciatis quo placeat
                                            officia maxime hic, ex fuga laborum
                                            eveniet. Atque tenetur temporibus
                                            suscipit voluptatibus earum
                                            architecto!
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="support-chat__send send">
                    ...
                    <textarea
                        className="send__text main-input"
                        cols="30"
                        rows="3"
