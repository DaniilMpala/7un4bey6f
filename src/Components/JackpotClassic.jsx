        ...
        <main className="jackpot">
            <div className="infoPlay">
                <div className="infoPlay-Info">
                    <span>
                        <span className="orange">ИГРА</span>{" "}
                        <span className="blue">#</span> 0
                    </span>
                    <span>
                        <span className="orange">БАНК</span>{" "}
                        <span className="blue">:</span> 0 руб
                    </span>
                </div>
                {dataUsers.length > 0 ? (
                ...
                <div className="classBetsSet">
                    ...
                    >
                        Вы внесли 0 предметов
                        <br />
                        Ваш шанс на победу 0%
                    </span>
                    <img src={`${process.env.PUBLIC_URL}/img/2arr.png`}></img>
                    <span>
                ...
                <div className="betsUser">
                    <div className="betsUser_info">
                        ...
                        <div className="tikets">
                            Билеты от: &nbsp;
                            <span className="orange"> 0</span>&nbsp; до &nbsp;
                    ...
                    <div className="betsUser_bet">
                        <div>
                            <img
                                title="fg"
                                src="https://steamcommunity-a.akamaihd.net/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXQ9QVcJY8gulRfSV7cTur_h56KHE59IjtSpaqsOQZux_yGIGkXut_kw4LfzvGiZr-Dxz8CscN02O_Epo2i2QTir0trZm_3LY7EcBh-Pw-wldGgpA/100x100f"
                            ></img>
                            <span>9.83</span>
                        </div>
                        <div>
